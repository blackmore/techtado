            ...
            if options[:validate_fields]
              ...
              if options[:validate_login_field]
                ...
                when :email
                  ...
                  validates_format_of options[:login_field], {:with => email_field_regex, :message => "should look like an email"}.merge(options[:login_field_validates_format_of_options])
                else
              ...
              if options[:validate_email_field] && options[:email_field]
                ...
                validates_format_of options[:email_field], {:with => email_field_regex, :message => "should look like an email"}.merge(options[:email_field_validates_format_of_options])
